...
[
    [ "Build OCCT", "build_upgrade__building_occt.html", [
      [ "Building with CMake tool", "build_upgrade__building_occt.html#build_occt_win_cmake", [
        [ "Configuration process", "build_upgrade__building_occt.html#build_cmake_conf", [
        ...
        [ "Cross-compiling (Android)", "build_upgrade__building_occt.html#build_occt_crossplatform_cmake", null ]
      ] ],
      [ "Building with Genproj tool", "build_upgrade__building_occt.html#build_occt_genproj", [
        [ "Configuration process", "build_upgrade__building_occt.html#build_genproj", null ],
        [ "Projects generation", "build_upgrade__building_occt.html#build_genproj_generate", null ],
        [ "Building", "build_upgrade__building_occt.html#build_genproj_build", [
          [ "Visual Studio", "build_upgrade__building_occt.html#build_msvc_build", null ],
          [ "Code::Blocks", "build_upgrade__building_occt.html#build_codeblocks_build", null ],
          [ "XCode", "build_upgrade__building_occt.html#build_occt_macos_xcode", null ]
        ] ]
      ] ]
    ] ],
    [ "Build 3rd-parties", "build_upgrade_building_3rdparty.html", [
      ...
      [ "Mac OS X", "build_upgrade_building_3rdparty.html#build_3rdparty_macos", [
        [ "Tcl/Tk", "build_upgrade_building_3rdparty.html#dev_guides__building_3rdparty_osx_2_1", null ],
        [ "FreeType", "build_upgrade_building_3rdparty.html#dev_guides__building_3rdparty_osx_2_2", null ],
        [ "TBB", "build_upgrade_building_3rdparty.html#dev_guides__building_3rdparty_osx_3_1", null ],
        [ "FreeImage", "build_upgrade_building_3rdparty.html#dev_guides__building_3rdparty_osx_3_3", null ]
      ] ]
    ] ],
    ...
    [ "Debugging tools and hints", "occt__debug.html", [
      ...
      [ "Using Visual Studio debugger", "occt__debug.html#occt_debug_vstudio", [
        ...
        [ "[AutoExpand] section", "occt__debug.html#autotoc_md32", null ],
        [ "[Visualizer] section", "occt__debug.html#autotoc_md33", null ]
      ] ],
    ...
    [ "Upgrade from older OCCT versions", "occt__upgrade.html", [
      ...
      [ "Upgrade to OCCT 6.9.0", "occt__upgrade.html#upgrade_690", [
        ...
        [ "Changes in Selection", "occt__upgrade.html#upgrade_690_selection", [
          [ "Standard selection", "occt__upgrade.html#autotoc_md34", null ],
          [ "Custom sensitive entities", "occt__upgrade.html#autotoc_md35", null ]
        ] ],
      ...
      [ "Upgrade to OCCT 7.0.0", "occt__upgrade.html#upgrade_700", [
        [ "Removal of legacy persistence", "occt__upgrade.html#upgrade_700_persist", [
          [ "CSFDB files", "occt__upgrade.html#autotoc_md36", null ],
          [ "OCAF and XCAF documents", "occt__upgrade.html#autotoc_md37", null ]
        ] ],
        [ "Removal of CDL and WOK", "occt__upgrade.html#upgrade_occt700_cdl", [
          ...
          [ "Missing header files", "occt__upgrade.html#autotoc_md38", null ],
          [ "Ambiguity of calls to overloaded functions", "occt__upgrade.html#autotoc_md39", null ],
          [ "Lack of implicit cast to base type", "occt__upgrade.html#autotoc_md40", null ],
          [ "Incorrect use of STANDARD_TYPE and Handle macros", "occt__upgrade.html#autotoc_md41", null ],
          [ "Use of class Standard_AncestorIterator", "occt__upgrade.html#autotoc_md42", null ],
          [ "Absence of cast to Standard_Transient*", "occt__upgrade.html#autotoc_md43", null ],
          [ "Method DownCast for non-base types", "occt__upgrade.html#autotoc_md44", null ],
          [ "Possible runtime problems", "occt__upgrade.html#upgrade_occt700_cdl_runtime", null ],
          [ "References to temporary objects", "occt__upgrade.html#autotoc_md45", null ],
        ...
        [ "UserDraw and Visual3d", "occt__upgrade.html#upgrade_occt700_userdraw", [
          [ "Visual3d package", "occt__upgrade.html#autotoc_md46", null ],
          [ "Custom OpenGL rendering and UserDraw", "occt__upgrade.html#autotoc_md47", null ]
        ] ],
      ...
      [ "Upgrade to OCCT 7.6.0", "occt__upgrade.html#upgrade_occt760", [
        [ "Simplification of surface/curve adaptor", "occt__upgrade.html#upgrade_760_handle_adaptors", null ],
        [ "Output of TCollection_ExtendedString to stream", "occt__upgrade.html#upgrade_760_extendedstring_cout", null ],
        [ "Trimming surface", "occt__upgrade.html#upgrade_760_trimming_surface", null ],
        [ "Storage format version of OCAF document", "occt__upgrade.html#upgrade_760_storageformatversion", null ],
        [ "New OCAF document", "occt__upgrade.html#upgrade_760_createdocument", null ],
        [ "Changes in storage of shapes", "occt__upgrade.html#upgrade_760_changesInStorageOfShapes", null ],
        [ "Changes in storage of binary document format", "occt__upgrade.html#upgrade_760_changesBinaryFormat", null ],
        [ "Changes in <em>Poly</em> package and <em>Poly_Triangulation</em> class", "occt__upgrade.html#upgrade_occt760_poly", null ],
        [ "Custom GLSL programs", "occt__upgrade.html#upgrade_occt760_glsl", null ],
        [ "Nodal color modulation", "occt__upgrade.html#upgrade_occt760_noral_colors", null ],
        [ "TKOpenGles library", "occt__upgrade.html#upgrade_occt760_tkopengles", null ],
        [ "Fast access to OCAF label", "occt__upgrade.html#upgrade_occt760_fast_access_to_labels", null ],
        [ "Progress indicator in Boolean operations", "occt__upgrade.html#upgrade_occt760_bop_progress_indicator", null ],
        [ "Changes in BRepLib_CheckCurveOnSurface & GeomLib_CheckCurveOnSurface interfaces", "occt__upgrade.html#upgrade_occt760_change_check_to_adaptors", null ],
        [ "Removal of old Boolean operations algorithm (BRepAlgo_BooleanOperation)", "occt__upgrade.html#upgrade_occt760_old_bop_removed", null ]
      ] ],
      [ "Upgrade to OCCT 7.7.0", "occt__upgrade.html#upgrade_occt770", [
        [ "Removed features", "occt__upgrade.html#upgrade_770_removed_features", null ],
        [ "Removed parameter theIsParallel from Put/Compute/Perform", "occt__upgrade.html#upgrade_occt770_parallel_flag_removed", null ],
        [ "Prs3d_Drawer aspects", "occt__upgrade.html#upgrade_occt770_drawer_aspects", null ],
        [ "OpenGL functions", "occt__upgrade.html#upgrade_occt770_opengl", null ],
        [ "StdPrs_ToolTriangulatedShape", "occt__upgrade.html#upgrade_occt770_tooltriangulatedshape", null ],
        [ "BRepExtrema_ShapeProximity", "occt__upgrade.html#upgrade_occt770_shapeproximity", null ]
      ] ],
      [ "Upgrade to OCCT 7.8.0", "occt__upgrade.html#upgrade_occt780", [
        [ "New Features and Recommendations", "occt__upgrade.html#upgrade_780_recommendations", null ],
        [ "Change in Default Clear Behavior for Containers", "occt__upgrade.html#upgrade_780_ncollection_update", null ],
        [ "Reworked Hash Mechanism for Hash Map (NCollection's map)", "occt__upgrade.html#upgrade_780_hash_utils", null ],
        [ "Removed Hash Specialization Classes", "occt__upgrade.html#upgrade_780_removed_files", null ],
        [ "Reorganized DE TK", "occt__upgrade.html#upgrade_780_tk_rework", null ],
        [ "Implemented STEP Thread-safety Interface", "occt__upgrade.html#upgrade_780_step_thread_safety", null ],
        [ "New Memory Management Functionality", "occt__upgrade.html#upgrade_780_new_memory_manager", null ],
        [ "New CMake Variable for Optimization Profiles", "occt__upgrade.html#upgrade_780_optimization_profiles", null ]
      ] ]
    ] ]
];